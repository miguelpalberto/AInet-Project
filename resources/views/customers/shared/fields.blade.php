...
<div class="mb-3 form-floating flex-grow-1 ms-2">
    <input type="address" class="form-control @error('address') is-invalid @enderror" name="address" id="inputAddress"
...
<div class="d-flex justify-content-between">
    ...
    <div class="mb-3 form-floating flex-grow-1 ms-2">
        <select class="form-select @error('default_payment_type') is-invalid @enderror" name="default_payment_type"
            ...
            <option {{ old('default_payment_type', $customer->default_payment_type) == 'MC' ? 'selected' : '' }}
                value="MC">MasterCard
            </option>
            <option {{ old('default_payment_type', $customer->default_payment_type) == 'PAYPAL' ? 'selected' : '' }}
                value="PAYPAL">Paypal
            </option>
        </select>
    ...
    <div class="mb-3 form-floating flex-grow-1 ms-2">
        <input type="text" class="form-control @error('default_payment_ref') is-invalid @enderror"
            name="default_payment_ref" id="inputDefaultPaymentRef" {{ $disabledStr }}
